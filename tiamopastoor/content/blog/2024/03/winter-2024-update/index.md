...
So I had to start writing again. Fortunately, my idea of "just write a lot and you'll get better" ringed true. I have much better structures and instincts now for writing stories than I had a few years ago. (I was actually surprised by this myself.)
...
And yes, this is a _lot_ of writing, especially for the Wildebyte books. They are half the size of regular novels, but even then it's outrageously fast to write one in two weeks. But that's just how it works for me. Any project that takes more than ~2 weeks means I lost interest and start working more and more slowly ... stop being productive and creative ... until the project is probably never finished.
...
I had also written down some _writing contests_ in which I could participate. I mostly wrote my entries for those at the start of January, though. Once I got into all my other writing work, I just lacked the time (on the weekends) to also focus on some writing competitions.
...
Some ideas placed close to each other ... were about games that are very _similar_. That feels silly and repetitive---so I spaced them out.
...
During this period, I prototyped 4 more of these games, but failed to find time to actually _develop_ them. That will come later.
...
{{% example %}}
I often made my decision whether to exercise or not that day _when I get out of bed_. But that's obviously a moment in which you don't feel great physically and are just starting up. Simply ... not doing that has allowed me to get more exercise and feel better about it. Now I make the decision whether to exercise any time I have a break during the day.
{{% /example %}}
...
* Saga of Life Cycle #3 finished.
* A few more Wildebyte Books
